...
import { ChevronLeft, Book, Sparkles, Bot, Share, Bookmark, Search, MoreHorizontal, User, CheckCircle, X, Library, List, ArrowRight, Highlighter, ShoppingBag } from 'lucide-react';
...
export const BooksApp: React.FC<BooksAppProps> = ({ onClose, silasEnabled = true, addToCart }) => {
  ...
  const books = [
      { id: 1, title: 'The Midnight Library', author: 'Matt Haig', progress: 45, image: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?auto=format&fit=crop&w=400&q=80', category: 'Fiction', price: 13.29 },
      { id: 2, title: 'Atomic Habits', author: 'James Clear', progress: 12, image: 'https://images.unsplash.com/photo-1589829085413-56de8ae18c73?auto=format&fit=crop&w=400&q=80', category: 'Self-Help', price: 16.99 },
      { id: 3, title: 'Dune', author: 'Frank Herbert', progress: 88, image: 'https://images.unsplash.com/photo-1541963463532-d68292c34b19?auto=format&fit=crop&w=400&q=80', category: 'Sci-Fi', price: 18.00 },
      { id: 4, title: 'Project Hail Mary', author: 'Andy Weir', progress: 5, image: 'https://images.unsplash.com/photo-1614583224978-f05ce51ef5fa?auto=format&fit=crop&w=400&q=80', category: 'Sci-Fi', price: 14.50 },
      { id: 5, title: 'The Silent Patient', author: 'Alex Michaelides', progress: 0, image: 'https://images.unsplash.com/photo-1589829085413-56de8ae18c73?auto=format&fit=crop&w=400&q=80', category: 'Thriller', price: 12.99 },
      { id: 6, title: 'Educated', author: 'Tara Westover', progress: 0, image: 'https://images.unsplash.com/photo-1544947950-fa07a98d237f?auto=format&fit=crop&w=400&q=80', category: 'Memoir', price: 15.00 },
  ];
          ...
          <div className="absolute inset-0 z-50 flex flex-col bg-white text-black animate-slide-in overflow-hidden">
              ...
              <div className="p-4 border-t border-gray-100 bg-white/90 backdrop-blur-md absolute bottom-0 w-full z-20 pb-8">
                  <div className="flex gap-3">
                      ...
                      <button 
                        onClick={(e) => handleAddToCart(e, { title: "The House in the Cerulean Sea", price: 12.99, image: "https://images.unsplash.com/photo-1543002588-bfa74002ed7e?auto=format&fit=crop&w=400&q=80" })}
                        className={`flex-[2] py-3 text-white font-bold rounded-xl shadow-lg active:scale-95 transition-transform flex items-center justify-center gap-2 ${addedToCart ? 'bg-green-600' : 'bg-black'}`}
                      >
                          {addedToCart ? (
              ...
              <div className="flex-1 overflow-y-auto px-6 py-6 no-scrollbar">
                  ...
                  <div className="flex gap-3 mb-8">
                      ...
                      <button 
                        ...
                        className={`flex-1 font-bold py-3 rounded-full flex items-center justify-center gap-2 ${addedToCart ? 'bg-green-600 text-white' : 'bg-gray-100 text-black'}`}
                      >
                          {addedToCart ? <CheckCircle size={16} /> : <ShoppingBag size={16} />}
                          {addedToCart ? 'Added' : `$${selectedBook.price}`}
                      </button>
                  </div>
