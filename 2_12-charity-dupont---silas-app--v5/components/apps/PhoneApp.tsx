...
export const PhoneApp: React.FC<PhoneAppProps> = ({ onBack, onClose, silasEnabled = true, onStartChat, contacts, setContacts, networkMode = 'STANDARD' }) => {
  ...
  const EMERGENCY_CONTACT_IDS = ['daniel', 'c2', 'c6'];
  ...
  // Populate Recents with a realistic history
  useEffect(() => {
      setRecents([
          { id: 'r1', contactId: 'daniel', date: '6:32 PM', type: 'incoming', isVideo: false }, 
          { id: 'r2', contactId: 'c2', date: '2:34 PM', type: 'missed', isVideo: false }, 
          { id: 'r3', contactId: 'c2', date: '2:30 PM', type: 'outgoing', isVideo: true }, 
          { id: 'r4', contactId: 'c3', date: 'Yesterday', type: 'missed', isVideo: false },
          { id: 'r5', contactId: 'c6', date: 'Yesterday', type: 'incoming', isVideo: false }, 
          { id: 'r6', contactId: 'c9', date: 'Tuesday', type: 'outgoing', isVideo: false },
          { id: 'r7', contactId: 'c10', date: 'Sunday', type: 'missed', isVideo: false },
          { id: 'r8', contactId: 'daniel', date: 'Sunday', type: 'incoming', isVideo: true },
          { id: 'r9', contactId: 'c7', date: 'Last Week', type: 'incoming', isVideo: false },
          { id: 'r10', contactId: 'c2', date: 'Last Week', type: 'outgoing', isVideo: false },
      ]);
  }, []);
                  ...
                  {!isEditing && (
                      <div className="flex justify-center gap-3 px-4 mb-6">
                          {[
                              ...
                              { icon: Phone, label: 'call', onClick: () => handleCall(contact, 'audio'), disabled: isDeceased }, 
