...
// --- Custom Components (Re-defined for independence) ---
...
export const AIApp: React.FC<AIAppProps> = ({ onClose, globalCart = [], setGlobalCart, silasConfig, setSilasConfig, onOpenApp, activityLog = [] }) => {
  ...
  if (!silasConfig.isSignedIn) {
      return (
          ...
          >
              ...
              <h1 className="text-4xl font-light mb-2 tracking-tight">AI <span className="font-bold text-green-400">Intelligence</span></h1>
              <p className="text-gray-500 mb-12 text-sm tracking-widest uppercase">System Version 3.0</p>
              <button 
      ...
      return (
          ...
          >
              ...
              <p className="text-gray-400 text-center mb-8 max-w-sm leading-relaxed">
                  AI Intelligence requires connection to your Safety Profile to function. Please enable "Connect to AI" in your device Settings.
              </p>
       ...
       {!activeEvidence && !activeTile && !readingArticle && (
           <div className="pt-14 pb-2 px-6 flex justify-between items-center z-20 bg-transparent shrink-0">
               <div className="flex items-center gap-3">
                   ...
                   <div>
                       <h1 className="text-lg font-bold leading-none tracking-tight">AI Intelligence</h1>
                       <span className="text-[10px] text-gray-500 uppercase tracking-widest">System v3.0</span>
                   </div>
               </div>
               <div 
                ...
                {activeTab === 'ACTIVITY' && (
                    <div className="px-6 animate-fade-in pb-24">
                        <div className="mt-4 mb-6">
                            ...
                            <p className="text-gray-500 text-sm">Recent actions performed by AI.</p>
                        </div>
                                    ...
                                    <div key={inf.id} className="bg-[#1c1c1e] rounded-2xl p-4 border border-white/5 flex items-center justify-between">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <span className={`text-[10px] ${inf.influences ? 'text-green-400' : 'text-gray-500'}`}>
                                                    {inf.influences ? 'Active' : 'Inactive'}
                                                </span>
                                            </div>
                                        </div>
                                        <div 
                ...
                {activeTab === 'PROFILE' && (
                    <div className="flex-1 overflow-y-auto px-6 pb-24 pt-4 animate-fade-in">
                        <div className="flex flex-col items-center mb-8 relative">
                            ...
                            <p className="text-sm text-gray-500">AI Profile Settings</p>
                        </div>
                        <div className="mb-6">
                    ...
                    {activeTile && (
                        ...
                        >
                            ...
                            <motion.div layoutId={`tile-${activeTile}`} className={`bg-[#111] border border-gray-800 rounded-3xl p-6 pointer-events-auto relative z-10 shadow-2xl flex flex-col overflow-hidden w-[90%] max-w-sm max-h-[80vh]`} onClick={(e) => e.stopPropagation()}>
                                ...
                                <div className="flex-1 overflow-y-auto no-scrollbar relative p-4 text-center text-gray-400">
                                    Feature content would load here...
                                </div>
                            </motion.div>
                        </motion.div>
                    )}
