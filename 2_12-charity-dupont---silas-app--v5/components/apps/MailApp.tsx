...
import { ChevronLeft, Search, Trash2, Reply, Edit, Folder, Flag, ChevronUp, ChevronDown, Filter, ChevronRight } from 'lucide-react';
        ...
        {view === 'DETAIL' && selectedEmail && (
          ...
          >
             ...
             <div className="bg-[#F9F9F9]/90 backdrop-blur-xl border-t border-gray-200 h-[83px] flex justify-between items-start pt-3 px-6 absolute bottom-0 w-full z-30">
                 ...
                 <button className="text-blue-500 active:opacity-50"><Edit size={24} strokeWidth={1.5} /></button>
             </div>
          </motion.div>
        )}
