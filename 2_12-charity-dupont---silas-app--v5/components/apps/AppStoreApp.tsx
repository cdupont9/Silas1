...
import { Search, Gamepad2, Layers, Star, User, Activity, Wallet, Moon, HardDrive, Plane, Scan } from 'lucide-react';
...
export const AppStoreApp: React.FC<AppStoreAppProps> = ({ onClose, installedApps, onInstall, onOpenApp }) => {
  ...
  const appsList = [
      ...
      },
      {
          ...
          name: 'Lost & Found',
          category: 'Utilities',
          desc: 'Track items with AR scanner.',
          iconColor: 'bg-[#2c2c2e]',
          icon: (
              <div className="w-full h-full flex items-center justify-center relative overflow-hidden bg-[#2c2c2e] border border-gray-700">
                  <Scan size={28} className="text-orange-500" />
              </div>
          )
      }
  ];
        ...
        <div className="px-5 mb-8">
            ...
            >
                ...
                <div className="absolute bottom-4 left-4">
                    ...
                    <div className="text-2xl font-bold text-white shadow-black drop-shadow-md italic">Lifetime Flights</div>
