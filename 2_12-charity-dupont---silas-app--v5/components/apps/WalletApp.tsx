  ...
  const cards: Card[] = [
      ...
      },
      {
          ...
          transactions: [
              ...
              { id: 't5', merchant: 'Lifetime Flights', location: 'Booking', amount: '$450.00', date: 'Monday', icon: Plane, category: 'Travel' },
          ]
      },
      {
          id: 'amex-plat',
                          ...
                          <div className="absolute inset-0 p-4 flex flex-col justify-between">
                              <div className="flex justify-between items-center text-white">
                                  <div className="flex items-center gap-2">
                                      <Plane size={18} />
                                      <span className="font-bold italic">Lifetime Flights</span>
                                  </div>
